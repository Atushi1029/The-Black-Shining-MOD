...
static const float TERRAIN_TILE_FREQ 			= 150.0f;// THIS?
...
static const float3 SNOW_COLOR 					= float3( 1, 1, 1 );
...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.9f;
...
static const float GB_CAM_MIN = 180.0f; //DH 150.0f;
static const float GB_CAM_MAX = 300.0f; //DH 350.0f;
static const float GB_CAM_MAX_FILLING_CLAMP = 1.0f; // DH 0.8f 0 to 1 value for clamping the fill when camera is at max distance
static const float GB_THRESHOLD = 0.05f; //DH 0.05f interpolation time
static const float GB_THRESHOLD2 = 0.25f; //DH 0.25f  interpolation time
