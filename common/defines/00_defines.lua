...
NGame = {
	START_DATE = "1972.1.1.12",
	END_DATE = "2022.12.31.12",
	...
	GAME_SPEED_SECONDS = { 1.0, 0.25, 0.1, 0.05, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
	...
	DECISION_ALERT_TIMEOUT_DAYS = 60,				-- Days left when player will be alerted about timing out events or decisions
	...
	HANDS_OFF_START_TAG = "JAP",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NDiplomacy = {
	...
	VOLUNTEERS_TRANSFER_SPEED = 1,					-- days to transfer a unit to another nation
	VOLUNTEERS_DIVISIONS_REQUIRED = 5,				-- This many divisons are required for the country to be able to send volunteers.
	...
	MAX_OPINION_FROM_VOLUNTEERS = 15,				-- Opinion bonus per one sent volunteer division
...
NCountry = {
	...
	BASE_STABILITY_PARTY_POPULARITY_FACTOR = 0.0,	-- Default stability rulling party popularity factor
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 1.5,	-- Weekly increase of PP.
